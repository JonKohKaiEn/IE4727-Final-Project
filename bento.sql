...
('Teriyaki Chicken Bento','classic',6.50,'Grilled chicken in teriyaki glaze, steamed rice, pickles, salad','assets/images/#'),
('Salmon Furikake Bento','classic',8.50,'Seared salmon with furikake rice, miso soup and vegetables','assets/images/#'),
('Tofu Veggie Bento','classic',5.60,'Crispy tofu, edamame, quinoa, sesame dressing','assets/images/#'),
...
('Beef Curry Bento','classic',8.50,'Beef slices with Japanese curry and seasonal greens','assets/images/#'),
('Chicken Sukiyaki Bento','classic',7.20,'Chicken slices simmered in sweet soy sauce, rice, tofu, and vegetables','assets/images/#'),
('Spicy Miso Veggie Bento','classic',8.00,'Miso-marinated vegetables with kimchi and rice','assets/images/#');
